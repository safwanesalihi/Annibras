...
const newsTitles = [
  ...
  "اتفاق دولي جديد للحد من الانبعاثات يدخل حيز التنفيذ مطلع الشهر",
  "إطلاق أول قمر اصطناعي عربي للاتصالات من الجيل الخامس",
  "منظمة الصحة العالمية تُحذّر من موجة جديدة من الأوبئة الموسمية",
  "افتتاح أكبر معرض للكتاب في المنطقة بمشاركة ٥٠ دولة",
  "تطورات ميدانية متسارعة في ملف المفاوضات السلمية بين الأطراف",
  "ارتفاع غير مسبوق في أسعار النفط بعد قرارات أوبك الأخيرة",
  "العثور على مخطوطات تاريخية نادرة في موقع أثري مكتشف حديثاً",
  "إنجاز رياضي تاريخي لمنتخب البلاد في البطولة القارية",
  "الحكومة تُعلن عن مشروع وطني كبير لتطوير قطاع الطاقات المتجددة",
  "اكتشاف علمي بارز في مجال علاج الأمراض المزمنة",
];
...
const newsSummaries = [
  ...
  "بدأ سريان اتفاقية المناخ الجديدة التي تضع سقفاً أعلى لمعدلات الانبعاثات وتُلزم الدول بتقديم تقارير دورية.",
  "انطلقت بنجاح عملية إطلاق أول قمر اصطناعي إقليمي يعمل وفق معايير الجيل الخامس من مركز الإطلاق الفضائي.",
  "أصدرت المنظمة بياناً تُحذّر فيه من موجة جديدة من الأوبئة الموسمية وتدعو إلى اتخاذ إجراءات وقائية عاجلة.",
  "افتُتحت اليوم فعاليات المعرض الدولي للكتاب بمشاركة آلاف الناشرين من خمسين دولة وحضور لافت للقُرّاء.",
  "تُسارع وفود التفاوض خطواتها بحثاً عن صيغة توافقية تُنهي حالة الجمود التي تشهدها الملفات منذ أسابيع.",
  "قفزت أسعار خام النفط إلى مستويات قياسية إثر إعلان منظمة أوبك تمديد تخفيضات الإنتاج لستة أشهر إضافية.",
  "عثرت بعثة أثرية على مخطوطات تعود إلى القرن الحادي عشر تُعيد كتابة جزء من التاريخ الفكري للمنطقة.",
  "حقّق المنتخب الوطني فوزاً تاريخياً مُكلِّلاً مشواره ببطولة قارية لأول مرة منذ عقود من المحاولات.",
  "كشفت الحكومة عن خطة استراتيجية طموحة لتوسيع قدرات الطاقات المتجددة بأكثر من الضعف خلال خمس سنوات.",
  "نجح فريق بحثي مشترك في التوصل إلى علاج واعد يُساهم في تخفيف أعراض أبرز الأمراض المزمنة وإطالة عمر المرضى.",
];
...
export const mockNews: NewsItem[] = newsTitles.map((title, i) => ({
  ...
  category: cat(
    ["politics", "economy", "science", "tech", "health", "culture", "politics", "economy", "culture", "sports", "economy", "health"][i],
  ),
  author: author(),
...
const articleTitles = [
  ...
  "قراءة في المشهد الإقليمي: ما بعد عقدٍ من التحولات الكبرى",
  "اقتصادات الجنوب: فرص النمو وتحديات النموذج التنموي القادم",
  "العمارة الإسلامية المعاصرة بين الأصالة والتحديث",
  "السينما العربية الجديدة: جيلٌ يعيد تعريف الصورة",
  "الرياضة كأداة دبلوماسية: من الملاعب إلى طاولات المفاوضات",
  "المدن الذكية: الوعد الكبير ومخاوف الخصوصية",
  "إصلاح التعليم في العالم العربي: الطريق إلى ٢٠٣٠",
  "الطاقة المتجددة: هل تكون رهان المنطقة في العقد المقبل؟",
  "أزمة المياه في الشرق الأوسط: قراءة في الأرقام والحلول",
  "صعود الإعلام البديل وتراجع الإعلام التقليدي",
...
const articleSummaries = [
  ...
  "محاولة لقراءة المتغيرات الجيوسياسية الكبرى التي عرفتها المنطقة على مدى العقد الماضي وآفاقها المستقبلية المحتملة.",
  "تحليل مُعمّق لتجارب اقتصادات الجنوب وقدرتها على بلورة نموذج تنموي عادل ومُستدام في ظل التحولات الراهنة.",
  "نظرة متأنية على إنجازات وتحديات العمارة الإسلامية المعاصرة وقدرتها على المواءمة بين الموروث والابتكار.",
  "موجة من الأعمال السينمائية الجريئة تبزغ من الإقليم وتفرض حضورها في أهم المهرجانات الدولية.",
  "كيف تحوّلت الأحداث الرياضية الكبرى إلى ساحة لتوازنات القوى الناعمة وإعادة تموضع الدول إقليمياً ودولياً.",
  "تتسابق العواصم لتحويل نفسها إلى مدن ذكية، لكن السؤال الجوهري يبقى: على حساب ماذا؟",
  "مراجعة شاملة لمسارات إصلاح التعليم في المنطقة العربية والمعايير الواجب توفرها لبناء أنظمة تعليمية فعّالة.",
  "مع تصاعد التحديات المناخية، تبدو الطاقات المتجددة الخيار الأكثر منطقية للمنطقة لتحقيق الأمن الطاقوي.",
  "تكشف الأرقام عن واقع مائي حرج في المنطقة يستدعي حلولاً جذرية بدلاً من الاستمرار في إدارة الأزمة.",
  "تشهد ساحة الإعلام تحولات جذرية تعيد تعريف العلاقة بين المنتج والمستهلك للمحتوى الإخباري والثقافي.",
...
export const mockArticles: Article[] = articleTitles.map((title, i) => ({
  ...
  category: cat(
    ["tech", "politics", "economy", "culture", "culture", "sports", "tech", "politics", "science", "science", "culture", "health"][i],
  ),
  author: author(),
  publishedAt: nextDate(),
  type: "article",
...
const blogTitles = [
  ...
  "ملاحظات هامشية على ضفاف قراءة طويلة",
  "حين تَهجر المُدن سُكّانها قبل أن يهجروها",
  "رسالة إلى جيل لم يَعرف الصبر",
  "عن البطء كأسلوب حياة في زمن السرعة",
  "مديح القراءة العميقة في عصر التصفح السطحي",
];

const blogSummaries = [
  "تأمل شخصي في فعل الكتابة بلغتنا الأم في زمن طغيان اللغات الأخرى على فضاءات النشر والمعرفة.",
  "ملاحظات متفرقة كَتبتها على هامش كتاب كبير، قبل أن أُدرك أنها أحياناً تكون الجوهر لا الهامش.",
  "تحوُّلات حضرية صامتة تُغيّر وجوه مُدننا، فتغدو غريبة عن أهلها قبل أن يُصبحوا غُرباء عنها.",
  "كلمات مُهداة إلى جيل وُلد في عصر الفورية، يحتاج أن يَتعلم كيف يَنتظر، وكيف يتأمل، وكيف يُصغي.",
  "في زمن يَركض الجميع فيه، يُصبح البطء جرأة، والتأني خياراً سياسياً ومعرفياً وأخلاقياً.",
  "كيف نستعيد قدرتنا على الانغماس في صفحة لساعات، بدل القفز السطحي بين عشرات النوافذ المفتوحة؟",
];
...
export const mockBreakingHeadlines: BreakingHeadline[] = [
  ...
  {
    id: "br3",
    text: "اتفاقية المناخ الجديدة تدخل حيز التنفيذ مطلع الشهر القادم",
    href: "/news/news-3",
  },
  {
    id: "br4",
    text: "نجاح إطلاق أول قمر اصطناعي إقليمي للاتصالات من الجيل الخامس",
    href: "/news/news-4",
  },
  {
    id: "br5",
    text: "اكتشاف علمي بارز في مجال علاج الأمراض المزمنة",
    href: "/news/news-12",
  },
];
